...
module Sync_Transmitter_Baud_9(CLK, CLR, CLK_Baud, Data, OUT_ser,RST
    );
...
reg RST_O;
wire Parity;
assign Parity = Data_Reg[0] ^ Data_Reg[1] ^ Data_Reg[2] ^ Data_Reg[3] ^ Data_Reg[4] ^ Data_Reg[5] ^ Data_Reg[6] ^ Data_Reg[7] ^ Data_Reg[8]; 
